...
fn main(p: Peripherals, c: Clocks) -> ! {
    ...
    writeln!(tx, "Welcome to console example by bouffalo-hal🦀!").ok();
    writeln!(tx, "Command helps: ").ok();
    writeln!(tx, "    led [<none>|on|off|switch]: operate on LED").ok();
